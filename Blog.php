...
<body>
	...
	<!--<p class="lead">The Complete blog using PHP by Athirah Khairi</p>-->
	</div>
	<div class="row"> <!--Row-->
		<div class="col-sm-8"> <!--Main Blog Area-->
				...
				$ViewQuery="SELECT * FROM admin_panel WHERE catagory='$catagory' ORDER BY id desc";	
					...
					$ShowPostFrom=($Page*7)-7;}
				$ViewQuery="SELECT * FROM admin_panel ORDER BY id desc LIMIT $ShowPostFrom,7";
					}
					// The Default Query for Blog.php Page
					else{
						
					$ViewQuery="SELECT * FROM admin_panel ORDER BY id desc LIMIT 0,7";}
					...
					<p class="description">Category:<?php echo htmlentities($catagory); ?> Published on
	...
	<p>	<div class="col-sm-offset-1 col-sm-3"> <!--Side Area -->
